       ...
       <div class="nav-header">
           <a href="index.html" class="brand-logo">
               <img class="logo-abbr rounded-circle" width="80" src="{{ asset('') }}assets/logo.jpg" alt="">
                   ...
                   <div class="collapse navbar-collapse justify-content-between">
                       ...
                       <ul class="navbar-nav header-right">
                                           ...
                                           <li>
                                               <div class="timeline-panel">
                                                   <div class="media me-2">
                                                       <img alt="{{ asset('') }}assets/image" width="50"
                           ...
                           <li class="nav-item dropdown header-profile">
                               <a class="nav-link" href="javascript:void(0)" role="button"
                                   data-bs-toggle="dropdown">
                                   <img src="{{ asset('') }}assets/logo.jpg" class="rounded-circle" width="80"
                                       alt="">
                               </a>
                               <div class="dropdown-menu dropdown-menu-end">
           ...
           <div class="deznav-scroll">
               <ul class="metismenu" id="menu">
                   ...
                   {{-- <li><a class=" ai-icon" href="/pemilihan" aria-expanded="false">
                           <i class="flaticon-381-networking"></i>
                           <span class="nav-text">Pemilihan</span>
                       </a>

                   </li> --}}
                   <li>
                       <a class=" ai-icon" href="/logout" aria-expanded="false">
                           <i class="flaticon-381-networking"></i>
