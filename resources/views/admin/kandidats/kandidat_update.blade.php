            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-validation">
                        <form class="needs-validation" method="POST" action="/kandidat/{{ $kandidats->id }}/update"
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input placeholder="............................." type="text"
                                                class="form-control" value="{{ $kandidats->nama }}" name="nama" required>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input placeholder="............................." type="text"
                                                class="form-control" value="{{ $kandidats->fakultas }}" name="fakultas"
                                                required>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input placeholder="............................." type="Prodi"
                                                class="form-control" value="{{ $kandidats->prodi }}" name="prodi"
                                                required>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input placeholder="............................." type="Domisili"
                                                class="form-control" value="{{ $kandidats->domisili }}" name="domisili"
                                                required>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input placeholder="............................." type="Umur"
                                                class="form-control" name="umur" value="{{ $kandidats->umur }}" required>
                                            <div class="invalid-feedback">
                                                Please enter a Umur.
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <select name="jenis_kelamin" class="default-select wide form-control"
                                                ...
                                                <option value="1"
                                                    {{ $kandidats->jenis_kelamin == 1 ? 'selected' : '' }}>Laki-Laki
                                                </option>
                                                <option value="0"
                                                    {{ $kandidats->jenis_kelamin == 0 ? 'selected' : '' }}>Perempuan
                                                </option>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <img src="{{ asset('foto_kandidats/' . $kandidats->gambar) }}"
                                                alt="Gambar Kandidat" class="img-fluid">

                                            <input placeholder="............................." type="file"
                                                name="gambar" value="{{ $kandidats->gambar }}" class="form-control"
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input placeholder="............................." type="text"
                                                name="no_whatsapp" value="{{ $kandidats->no_whatsapp }}"
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input placeholder="............................." type="email"
                                                name="email" class="form-control" value="{{ $kandidats->email }}"
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class="form-control" placeholder="............................." name="visi" id="validationCustom04"
                                                rows="5" required>{{ $kandidats->visi }}</textarea>
                                            <div class="invalid-feedback">
                                                Please enter a Visi.
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class="form-control" placeholder="............................." name="misi" id="validationCustom04"
                                                rows="5" required>{{ $kandidats->misi }}</textarea>
                                            <div class="invalid-feedback">
                                                Please enter a Misi.
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input placeholder="............................." type="text"
                                                name="tinggi_badan" value="{{ $kandidats->tinggi_badan }}"
                                                class="form-control" id="validationCustom10" required>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input placeholder="............................." type="text"
                                                class="form-control" value="{{ $kandidats->berat_badan }}"
                                                name="berat_badan" id="validationCustom10" required>
                                            <div class="invalid-feedback">
